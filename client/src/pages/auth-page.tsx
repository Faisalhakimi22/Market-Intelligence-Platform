...
// Add these new components before AuthPage
const GlowingButton = ({ children, className, ...props }: any) => {
  return (
    <motion.button
      className={cn(
        "relative inline-flex items-center justify-center px-6 py-3 overflow-hidden rounded-lg group",
        "bg-gradient-to-br from-primary/80 to-purple-600/80",
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "bg-gradient-to-b from-background/80 to-muted/30",
        "backdrop-blur-xl",
        className
      )}
    >
      <div className="relative z-10">{children}</div>
      <div className="absolute inset-0 bg-gradient-to-b from-primary/5 to-purple-500/5" />
    </motion.div>
  );
};
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-purple-500/5 to-background/0" />
      </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Badge 
                variant="secondary" 
                className="px-4 py-1 mb-6 bg-primary/10 text-primary dark:bg-primary/20"
              >
            ...
            >
              Harness the power of advanced AI to predict market trends, analyze competitors, 
              and identify growth opportunities with unparalleled accuracy.
            </motion.p>
            ...
            >
              <GlowingButton onClick={() => switchView("auth")}>
                Get Started Free
              </GlowingButton>
            ...
            >
              <div className="flex -space-x-3">
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full border-2 border-background bg-gradient-to-br from-primary/80 to-purple-600/80"
                  />
                ))}
              </div>
              <div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5, delay: 0.3 }}
          >
            <FloatingCard className="relative z-20">
              <div className="absolute top-2 left-2 right-2 flex items-center px-4 py-2 bg-muted/50 rounded-lg backdrop-blur-sm">
                ...
                <div className="flex-1 text-center">
                  <span className="text-xs text-muted-foreground">Forecastro AI Dashboard</span>
                </div>
              </div>

              <div className="mt-8 space-y-4">
                {/* Chart Preview */}
                <div className="h-40 bg-gradient-to-r from-primary/10 to-purple-500/10 rounded-lg flex items-end p-4">
                  {[...Array(12)].map((_, i) => (
                    <motion.div
                      key={i}
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    { label: "Market Growth", value: "+24.8%" },
                    { label: "AI Confidence", value: "98.2%" },
                    { label: "Predictions", value: "2.4K" },
                  ].map((stat, i) => (
                    <motion.div
                      key={i}
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Advanced AI-Powered Features for
                <span className="text-primary"> Market Intelligence</span>
              </h2>
              <p className="text-lg text-muted-foreground">
                Leverage cutting-edge artificial intelligence to gain unprecedented insights
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <FloatingCard key={i} delay={0.1 + i * 0.1}>
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join thousands of businesses already using Forecastro AI to stay ahead of the competition.
              </p>
              <div className="flex flex-wrap gap-4 justify-center">
                <GlowingButton onClick={() => switchView("auth")} className="px-8">
                  Start Free Trial
                </GlowingButton>

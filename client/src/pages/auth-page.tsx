...
// Add this component before the ModernHeader component
const AdvancedGradientBackground = () => {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden">
      <div className="absolute w-full h-full bg-background opacity-80" />
      
      {/* Dynamic background gradients */}
      <div className="absolute top-0 left-0 right-0 bottom-0 overflow-hidden">
        <motion.div 
          className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-gradient-to-r from-primary/30 to-purple-500/20 rounded-full blur-[120px]"
          animate={{
            x: [0, 100, 0],
            y: [0, 50, 0],
          }}
        ...
        />
        <motion.div 
          className="absolute -bottom-1/4 -right-1/4 w-2/3 h-2/3 bg-gradient-to-l from-blue-500/20 to-primary/30 rounded-full blur-[120px]"
          animate={{
            x: [0, -100, 0],
            y: [0, -50, 0],
          }}
        ...
        />
        <motion.div 
          className="absolute top-1/3 right-1/3 w-1/3 h-1/3 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full blur-[100px]"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.5, 0.3, 0.5],
          }}
...
// Add this component above DemoModal
const GlowingButton = ({ children, className, ...props }) => {
  return (
    <motion.button
      ...
      {...props}
    >
      <div className="absolute inset-0 bg-gradient-to-r from-primary to-purple-600 rounded-full" />
      <motion.div
        className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-r from-primary via-purple-600 to-pink-500 rounded-full"
        animate={{
      ...
      />
      <div className="absolute inset-[2px] bg-background dark:bg-background rounded-full flex items-center justify-center">
        <div className="relative z-10 px-6 py-2.5 text-sm font-medium">
          {children}
        </div>
      </div>
    </motion.button>
        ...
        <section className="relative pt-32 pb-16 overflow-hidden">
          ...
          <div className="container mx-auto px-6">
            ...
            <motion.div
              ...
              className="relative max-w-5xl mx-auto mt-12 h-[500px] rounded-xl border border-border/40 shadow-2xl shadow-primary/5 overflow-hidden backdrop-blur-sm bg-background/10"
            >
              <div className="absolute inset-0 z-10">
                <ModelViewer modelPath="/models/dashboard_3d.glb" />
                
                {/* Floating info cards */}
                <FloatingCard 
                  delay={0.5}
                  className="absolute top-24 left-24 max-w-[200px]"
                >
                  <div className="bg-card/80 backdrop-blur-md rounded-lg p-4 border border-border/50 shadow-lg">
                ...
                <FloatingCard 
                  delay={0.8}
                  className="absolute top-48 right-48 max-w-[200px]"
                >
                  <div className="bg-card/80 backdrop-blur-md rounded-lg p-4 border border-border/50 shadow-lg">
                    <div className="flex items-center gap-2 mb-2">
                ...
                <FloatingCard 
                  delay={1.1}
                  className="absolute bottom-32 left-1/3 max-w-[200px]"
                >
                  <div className="bg-card/80 backdrop-blur-md rounded-lg p-4 border border-border/50 shadow-lg">
                    <div className="flex items-center gap-2 mb-2">
              ...
              {/* Stats overlay */}
              <div className="absolute bottom-0 left-0 right-0 z-30 p-6 bg-background/50 backdrop-blur-md border-t border-border/20">
                <div className="flex items-center justify-between gap-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-semibold">+24.8%</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-semibold">0.3ms</div>
                    </div>
                  </div>
                </div>
              </div>
...
// Add these icon components after the Logo component
// Create the social media icon components 
const FacebookIcon = () => (
  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
// Example social icons section for the footer
const SocialIcons = () => (
  <div className="flex space-x-4">
    <a href="#" className="text-muted-foreground hover:text-primary transition-all duration-200 hover:scale-110">
      <FacebookIcon />
